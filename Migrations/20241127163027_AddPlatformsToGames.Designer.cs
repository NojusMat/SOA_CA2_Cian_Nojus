...
namespace SOA_CA2_Cian_Nojus.Migrations
{
    ...
    [Migration("20241127163027_AddPlatformsToGames")]
    partial class AddPlatformsToGames
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GamesPlatform", b =>
                {
                    b.HasOne("SOA_CA2_Cian_Nojus.Models.Games", null)
                        .WithMany()
                        .HasForeignKey("GamesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SOA_CA2_Cian_Nojus.Models.Platform", null)
                        .WithMany()
